...
namespace QLcuahangbanmaytinh
{
    public partial class frmnhanvien : Form
    {
        ...
        {
            string sqlthem = "insert into Nhanvien values ('" + txtmanv.Text + "','" + txttennv.Text + "','" + txtgioitinh.Text + "','" + txtdiachi.Text + "','" + txtsdt.Text + "','" + txt_matkhau.Text + "')";
            co.ThucThi(sqlthem);
        ...
        private void btnsua_Click(object sender, EventArgs e)
        {
            string sqlsua = "update Nhanvien set MaNV='" + txtmanv.Text
             + "',TenNV='" + txttennv.Text + "',Gioitinh = '" + txtgioitinh.Text + "',Diachi='" + txtdiachi.Text + "',sdt='" + txtsdt.Text + "',MatKhau='" + txt_matkhau.Text + "'where MaNV='" + txtmanv.Text + "'";
            co.ThucThi(sqlsua);
            LoadData();
            frmnhanvien_Load(sender, e);
        }
        ...
        private void dgvnhanvien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txt_matkhau.Text = dgvnhanvien.Rows[i].Cells[5].Value.ToString().Trim();
        }
